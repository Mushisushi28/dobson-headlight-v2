      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {PACKAGES.map((pkg) => (
            <div 
              key={pkg.id} 
              className={`relative flex flex-col p-10 rounded-[2.5rem] transition-all duration-500 hover:-translate-y-2 border-2 ${
                pkg.popular 
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
                    ...
                    <div className="bg-slate-950 p-8 rounded-[2rem] border border-yellow-400/30 shadow-2xl relative overflow-hidden group hover:border-yellow-400 transition-colors">
                        ...
                        <p className="text-xs text-yellow-400 font-bold uppercase tracking-widest">Mobile Service Included</p>
                    </div>
                </div>
            </div>
        </div>
