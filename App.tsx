            ...
            <div className="grid md:grid-cols-3 gap-12 items-start relative">
              ...
              {[
                ...
                { 
                  ...
                  desc: "Mobile service at your home or work. No need to drop your car off for the day." 
                },
                { 
                  Icon: Shield, 
        ...
        <section id="gallery" className="py-24 bg-slate-950 scroll-mt-20 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 font-bold max-w-2xl mx-auto">Browse our full gallery of mobile restorations across Southern Alberta. Hover any vehicle to see the "Before" state.</p>
            </div>
        ...
        <section id="areas" className="py-24 bg-white border-y border-slate-100 scroll-mt-20">
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="bg-slate-50 rounded-[3rem] p-12 md:p-20 text-center border border-slate-100 relative overflow-hidden">
                ...
                <p className="text-slate-500 mb-12 max-w-2xl mx-auto text-lg font-bold leading-relaxed relative z-10">Serving Southern Alberta with professional mobile services at your home or workplace.</p>
